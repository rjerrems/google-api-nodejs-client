...
describe('analyticsReporting samples', () => {
    ...
    it('should batchGet', () => __awaiter(this, void 0, void 0, function* () {
        const scope = nock(baseUrl).post(`/v4/reports:batchGet`).reply(200, {});
        const data = yield samples.batchGet.runSample();
        assert(data);
        scope.done();
    }));
});
//# sourceMappingURL=test.samples.analyticsReporting.js.map